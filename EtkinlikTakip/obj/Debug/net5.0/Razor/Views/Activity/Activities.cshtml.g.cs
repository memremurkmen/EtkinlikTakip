#pragma checksum "C:\Users\emret\source\repos\EtkinlikTakip\EtkinlikTakip\Views\Activity\Activities.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "69bf065d4c03431da696655c21dcbac0f5752a2f"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"69bf065d4c03431da696655c21dcbac0f5752a2f", @"/Views/Activity/Activities.cshtml")]
...
#line hidden
#nullable disable
            WriteLiteral(@"<div id=""team-schedule"">
    <div id=""Grup"">
...
<div>
    ");
#nullable restore
#line 22 "C:\Users\emret\source\repos\EtkinlikTakip\EtkinlikTakip\Views\Activity\Activities.cshtml"
Write(Html.Kendo().Scheduler<Activity>()
    ...
    m.Field(f => f.Description).DefaultValue(null);
    m.Field(f => f.IsAllDay).DefaultValue(false);
    m.Field(f=> f.CreatedTime).DefaultValue(DateTime.Now);
    m.Field(f=> f.Fotograf).DefaultValue(null);
    m.Field(f=> f.Lokasyon).DefaultValue(null);
    m.Field(f=> f.Grup).DefaultValue("Yazılım Daire Başkanlığı");
    m.Field(f=> f.MaksKontenjan).DefaultValue(1);
    m.Field(f=> f.IsConfirmed).DefaultValue(false);
    m.Field(f=> f.IsDeleted).DefaultValue(false);
    })
    .Read("ActivityRead", "Activity")
    
    .Create("ActivityCreate", "Activity").Events(a => a.RequestEnd("locationErrPopup"))
    .Update("ActivityUpdate", "Activity")
    .Destroy("ActivityDestroy", "Activity")
    .Filter(filters =>
    {
    filters.Add(model => model.Grup)
...
#line hidden
#nullable disable
            WriteLiteral("\r\n</div>\r\n<script type=\"text/javascript\">\r\n    function locationErrPopup(e, x) {\r\n        console.log(e);\r\n        var locationCntrl = \'");
#nullable restore
#line 121 "C:\Users\emret\source\repos\EtkinlikTakip\EtkinlikTakip\Views\Activity\Activities.cshtml"
                        Write(ViewBag.locationCntrl);

#line default
#line hidden
#nullable disable
            WriteLiteral("\';\r\n        console.log(locationCntrl);\r\n        if (\'");
#nullable restore
#line 123 "C:\Users\emret\source\repos\EtkinlikTakip\EtkinlikTakip\Views\Activity\Activities.cshtml"
        Write(ViewBag.locationCntrl);
...
#nullable disable
            ...
            swal(
                ...
                'Oluşturmak istediğiniz etkinlik başka bir etkinlik ile çakışıyor.',
                'warning'
            )
        }
    }
    var Ajanda = kendo.ui.AgendaView.extend({
        ...
        endDate: function() {
            ...
            return kendo.date.addDays(date, 23);
        }
    });
    function onActivityDataBind(e) {
        var locationCntrl = '");
#nullable restore
#line 142 "C:\Users\emret\source\repos\EtkinlikTakip\EtkinlikTakip\Views\Activity\Activities.cshtml"
                        Write(ViewBag.locationCntrl);
...
#nullable disable
            WriteLiteral("\';\r\n        console.log(locationCntrl);\r\n        if (\'");
#nullable restore
#line 144 "C:\Users\emret\source\repos\EtkinlikTakip\EtkinlikTakip\Views\Activity\Activities.cshtml"
        Write(ViewBag.locationCntrl);
...
#nullable disable
    ...
    $(document).ready(function() {
        $(""#Grup :checkbox"").change(function(e) {
            var checked = $.map($(""#Grup :checked""), function(checkbox) {
      ");
            WriteLiteral(@"          return $(checkbox).val();
            });
            var filter = {
                logic: ""or"",
    ...
    function scheduler_edit(e) {
        var role = '");
#nullable restore
#line 197 "C:\Users\emret\source\repos\EtkinlikTakip\EtkinlikTakip\Views\Activity\Activities.cshtml"
...
#nullable disable
            WriteLiteral("\';\r\n        var userId = \'");
#nullable restore
#line 198 "C:\Users\emret\source\repos\EtkinlikTakip\EtkinlikTakip\Views\Activity\Activities.cshtml"
...
#nullable disable
    ...
    function userDropdown(id) {
        $.ajax({
            url: """);
#nullable restore
#line 214 "C:\Users\emret\source\repos\EtkinlikTakip\EtkinlikTakip\Views\Activity\Activities.cshtml"
...
#nullable disable
    ...
    function InviteRequest(id, userId) {
        $.ajax({
            url: """);
#nullable restore
#line 252 "C:\Users\emret\source\repos\EtkinlikTakip\EtkinlikTakip\Views\Activity\Activities.cshtml"
...
#nullable disable
            ...
            success: function(data) {
                if (!data.isInvited) {
                    ...
                    swal({
 ");
            WriteLiteral(@"                       title: 'İşlem Yapılmadı!',
    ...
    function getFileName() {
        ...
        document.getElementById(""Fotograf"").value = file.files[0].name;
    }

</script>
<script id=""customEventTemplate"" type=""text/x-kendo-template"">
    <div class='movie-template' style='margin: 5px 5px 5px 5px;'>
        #if(Fotograf != null && Fotograf != """"){#
            <img src='/images/#= Fotograf #' style=""max-width:40px; max-height:40px;""/>
        #}#
        <strong>#= title #</strong>
...
<script id=""activityEditTemplate"" type=""text/x-kendo-template"">
        <div style=""width: 100%; display: table; border-spacing:3px;"">
            <div style=""display: table-row;"">
                <div id=""editTempCell"" style="" disp");
            WriteLiteral("lay: table-cell; padding:10px; \">\r\n                    <div class=\"container-fluid\">\r\n                        <h4>Detay</h4>\r\n");
...
");
            WriteLiteral(@"                        <div class=""k-edit-label""><label for=""end"">Bitiş</label></div>
                ...
                ");
            WriteLiteral("            <span data-bind=\"text: startTimezone, invisible: endTimezone\"></span>\r\n                            <span data-for=\"end\" class=\"k-invalid-msg\" style=\"display: none;\"></span>\r\n                        </div>\r\n");
...
");
            WriteLiteral(@"                        <div class=""k-edit-label""><label for=""Grup"">Grup</label></div>
                        <div data-container-for=""Grup"" class=""k-edit-field"">
                            <select id=""Grup"" name=""Grup"" required=""required"" data-required-msg=""Lütfen bir grup seçiniz!""
                            data-bind=""value:Grup"" data-role=""dropdownlist"" data-value-field=""value"" data-text-field=""text"">
                                <option value=""Yazılım Daire Başkanlığı"">Yazılım Daire Başkanlığı</option>
                                <option value=""İdari İşler Başkanlığı"">İdari İşler Başkanlığı</option>
                                <option value=""Cumhurbaşkanlığı Koruma Dairesi Başkanlığı"">Cumhurbaşkanlığı Koruma Dairesi Başkanlığı</option>
                            </select>
                        </div>
");
            WriteLiteral(@"                        <div class=""k-edit-label""><label for=""Lokasyon"">Lokasyon</label></div>
                        <div data-container-for=""Lokasyon"" class=""k-edit-field"">
                            <input type=""text"" data-role=""textbox"" id=""Lokasyon"" name=""Lokasyon"" required=""required"" data-required-msg=""Lütfen lokasyonu boş bırakmayınız!"" data-bind=""value:Lokasyon""/>
                        </div>
");
            WriteLiteral(@"                        <div class=""k-edit-label""><label for=""MaksKontenjan"">Maksimum Kontenjan</label></div>
                        <div data-container-for=""MaksKontenjan"" class=""k-edit-field"">
                            <input type=""number"" min=""1"" data-role=""textbox"" name=""MaksKontenjan""
                            required=""required"" data-required-msg=""Lütfen kontenjanı boş bırakmayınız!""
                            data-min-msg=""Kontenjan sayısını en az 1 olarak belirleyebilirsiniz!""
                            data-bind=""value:MaksKontenjan""/>
                        </div>
");
            WriteLiteral(@"                        <div class=""k-edit-label""><label for=""Fotograf"">Fotoğraf</label></div>
                        <div data-container-for=""Fotograf"" class=""k-edit-field"">
                            <input id=""Fotograf"" type=""file"" data-role=""file"" name=""Fotograf"" accept=""image/*"">
                            #if(Fotograf != null && Fotograf != """"){#
                                <img alt=""etkinlikFotografi"" src=""/images/#= Fotograf #"" style=""padding: 5px 5px 5px 5px; max-width:300px; max-height:150px; min-width:100px; min-height:100px;"" width=""auto"" height=""auto"" >
                            #}#
                        </div>
                    </div>
                </div>
                ...
                <div style=""display: table-cell; vertical-align: top; padding:10px; "">
                    <div class=""container-fluid"">
                        ...
                        <br>
                ");
            WriteLiteral(@"    <input value=""Davetli ekle"" type=""button"" onclick=""userDropdown(#=ID#)"" class='k-button k-button-md k-rounded-md k-button-solid k-button-solid-success'>
                    </div>
                </div>
                #}#
            </div>
        ...
        $(""#userGrid"").kendoGrid({
            dataSource: {
                ...
                transport: {
                    read: """);
#nullable restore
#line 440 "C:\Users\emret\source\repos\EtkinlikTakip\EtkinlikTakip\Views\Activity\Activities.cshtml"
...
<script id=""activityDetailTemplate"" type=""text/x-ken");
            WriteLiteral("do-template\">\r\n");
...
");
            WriteLiteral("    <div class=\"k-edit-label\"><strong for=\"Lokasyon\">Lokasyon</strong></div>\r\n    <div data-container-for=\"Lokasyon\" class=\"k-edit-field\">\r\n        <label style=\"padding: 7px 0px;\" for=\"Lokasyon\">#= Lokasyon #</label>\r\n    </div>\r\n</script>");
        }
