#pragma checksum "C:\Users\emret\source\repos\EtkinlikTakip\EtkinlikTakip\Views\Activity\Activities.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "1f438db185c8a0e10e5435dd20fcc9d979290d41"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"1f438db185c8a0e10e5435dd20fcc9d979290d41", @"/Views/Activity/Activities.cshtml")]
...
Write(Html.Kendo().Scheduler<Activity>()
    ...
    m.Field(f=> f.Location).DefaultValue(null);
...
<script type=""text/javascript"">
    ...
    function onDataBound(e) {
        ...
        grid.table.find(""tr"").each(function() {
            ...
            console.log(""user IsConfirmed: "" + dataItem.IsConfirmed);
    ...
    function scheduler_edit(e) {
        var role = '");
#nullable restore
#line 172 "C:\Users\emret\source\repos\EtkinlikTakip\EtkinlikTakip\Views\Activity\Activities.cshtml"
...
#nullable disable
            WriteLiteral("\';\r\n        var userId = \'");
#nullable restore
#line 173 "C:\Users\emret\source\repos\EtkinlikTakip\EtkinlikTakip\Views\Activity\Activities.cshtml"
...
#nullable disable
    ...
    function userDropdown(id) {
        $.ajax({
            url: """);
#nullable restore
#line 189 "C:\Users\emret\source\repos\EtkinlikTakip\EtkinlikTakip\Views\Activity\Activities.cshtml"
...
#nullable disable
    ...
    function InviteRequest(id, userId) {
        $.ajax({
            url: """);
#nullable restore
#line 227 "C:\Users\emret\source\repos\EtkinlikTakip\EtkinlikTakip\Views\Activity\Activities.cshtml"
...
<script id=""activityEditTemplate"" type=""text/x-kendo-template"">
        <div style=""width: 100%; display: table; border-spacing:3px;"">
            <div style=""display: table-row;"">
                <div id=""editTempCell"" style="" display: table-cell; padding:10px; ");
...
");
            ...
            WriteLiteral(@"                        <div class=""k-edit-label""><label for=""Location"">Lokasyon</label></div>
                        <div data-container-for=""Location"" class=""k-edit-field"">
                            <input type=""text"" data-role=""textbox"" id=""Location"" name=""Location"" required=""required"" data-required-msg=""Lütfen lokasyonu boş bırakmayınız!"" data-bind=""value:Location""/>
                        </div>
");
...
");
            WriteLiteral(@"                        <div class=""k-edit-label""><label for=""Image"">Fotoğraf</label></div>
                        <div data-container-for=""Image"" class=""k-edit-field"">
                            <input id=""Image"" type=""file"" data-role=""file"" name=""Image"" accept=""image/*"">
                            #if(Image != null && Image != """"){#
                ...
                <div style=""display: table-cell; vertical-align: top; padding:10px; "">
                    <div class=""container-fluid"">
                        ...
                        <br>
                    <input value=""Davetli ekle"" type=""button""");
            WriteLiteral(@" onclick=""userDropdown(#=ID#)"" class='k-button k-button-md k-rounded-md k-button-solid k-button-solid-success'>
                    </div>
                </div>
                #}#
            </div>
...
<script>
    function detailUserGrid(activityId) {
        var editTempHeight = document.getElementById(""editTempCell"").offsetHeight;
        $(""#userGrid"").kendoGrid({
            dataSource: {
                type: ""jsonp"",
                transport: {
                    read: """);
#nullable restore
#line 417 "C:\Users\emret\source\repos\EtkinlikTakip\EtkinlikTakip\Views\Activity\Activities.cshtml"
