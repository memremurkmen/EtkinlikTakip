#pragma checksum "C:\Users\emret\source\repos\EtkinlikTakip\EtkinlikTakip\Views\Activity\Activities.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "71363bea291d210090ef540aa11bfb1299e07cac"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"71363bea291d210090ef540aa11bfb1299e07cac", @"/Views/Activity/Activities.cshtml")]
...
Write(Html.Kendo().Scheduler<Activity>()
    ...
    e.DataBinding("onActivityDataBind");
    })
    .Timezone("Etc/UTC")
    .Footer(false)
    .Views(views =>
...
#line hidden
#nullable disable
            WriteLiteral("\r\n</div>\r\n<script type=\"text/javascript\">\r\n    function locationErrPopup(e, x) { debugger\r\n        console.log(e);\r\n        console.log(\"locationErrPopup\'a girdi\");\r\n        var locationCntrl = \'");
#nullable restore
#line 122 "C:\Users\emret\source\repos\EtkinlikTakip\EtkinlikTakip\Views\Activity\Activities.cshtml"
                        Write(ViewData["locationCntrl"]);
...
#nullable disable
        ...
        if (locationCntrl.toLowerCase() == 'false') {
            swal(
    ...
    function onActivityDataBind(e) {
        var locationCntrl = '");
#nullable restore
#line 143 "C:\Users\emret\source\repos\EtkinlikTakip\EtkinlikTakip\Views\Activity\Activities.cshtml"
                        Write(ViewData["locationCntrl"]);
...
#nullable disable
    ...
    $(document).ready(function() {
        $(""#Grup :checkbox"").change(function(e) {
            var checked = $.map($(""#G");
            WriteLiteral(@"rup :checked""), function(checkbox) {
                return $(checkbox).val();
            });
            var filter = {
                logic: ""or"",
...
function kaydetBtn(e) {

}
    function scheduler_edit(e) {
        var role = '");
#nullable restore
#line 200 "C:\Users\emret\source\repos\EtkinlikTakip\EtkinlikTakip\Views\Activity\Activities.cshtml"
...
#nullable disable
            WriteLiteral("\';\r\n        var userId = \'");
#nullable restore
#line 201 "C:\Users\emret\source\repos\EtkinlikTakip\EtkinlikTakip\Views\Activity\Activities.cshtml"
...
#nullable disable
        ...
        if (role == ""Personel"") {
            ...
            //e.container.find("".k-scheduler-update"").onclick(""kaydetBtn"");
    ...
    function userDropdown(id) {
        $.ajax({
            url: """);
#nullable restore
#line 218 "C:\Users\emret\source\repos\EtkinlikTakip\EtkinlikTakip\Views\Activity\Activities.cshtml"
...
#nullable disable
    ...
    function InviteRequest(id, userId) {
        $.ajax({
            url: """);
#nullable restore
#line 256 "C:\Users\emret\source\repos\EtkinlikTakip\EtkinlikTakip\Views\Activity\Activities.cshtml"
        ...
        $(""#userGrid"").kendoGrid({
            dataSource: {
                ...
                transport: {
                    read: """);
#nullable restore
#line 444 "C:\Users\emret\source\repos\EtkinlikTakip\EtkinlikTakip\Views\Activity\Activities.cshtml"
